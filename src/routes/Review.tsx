                ...
                <Flex width={"518px"} gap={"20px"} alignItems={"center"}>
                  <Flex gap={"8px"} alignItems={"center"}>
                    <Image
                      width={"32px"}
                      height={"32px"}
                      src="https://i.pinimg.com/originals/89/20/75/89207596518f2e149e67bf7f0946c7ca.png"
                    />
                    <Text textStyle={"h9"}>JustKeepPaintingProj</Text>
                  </Flex>

                  <Flex gap={"8px"} alignItems={"center"}>
                    <Text textStyle={"bodyXs14R"}>2023.09.21 주문</Text>
            ...
            <Flex width={"828px"}>
              ...
              >
                <Flex flexDirection={"column"} gap={"6px"}>
                  ...
                  <Text textStyle={"bodyXs14M"}>20,000원</Text>
                ...
                >
                  ...
                  <Flex flexDirection={"column"}>
                    ...
                    <Flex alignItems={"center"} gap={"20px"}>
                      ...
                      <Text fontSize={"12px"}>
                        사진은 최대 20MB 이하의 JPG, PNG, GIF 파일 5장까지 첨부
                        가능합니다.
                      </Text>
                    </Flex>
                    <Flex gap={"8px"} alignSelf={"flex-end"}>
                      <ArtantButton
                        ...
                        onClick={() => {}}
                      />
                      <BlackButton title={"등록하기"} borderRadius={"5px"} />
                    </Flex>
                  </Flex>
                </Flex>
              </Flex>
