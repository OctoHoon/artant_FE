...
export default function CartComponent({
  ...
  return (
    <Flex width="828px" alignItems={"flex-start"} flexDirection={"column"}>
      <Flex
        alignItems={"center"}
        justifyContent={"space-between"}
        width={"828px"}
      >
        <Flex gap="8px" alignItems={"center"} padding={"10px"}>
          <Avatar src={data.shop_avatar} borderRadius={"5px"} />
      ...
      {data.cart_lines.map((item) => (
        <Flex flexDirection={"column"}>
          <Box width={"full"} height={"1px"} backgroundColor={"#D9D9D9"} />
          <Flex gap={"16px"} padding={"10px"}>
            <Image
                  ...
                  >
                    ...
                    >
                      <Text
                        ...
                        color=" var(--maincolorstextgray-595959, #666)"
                      >
                        위 입력 창에 선물메시지를 입력하세요. 보내는
                        사람/받는사람 이름을 반드시 포함해 주세요.
                      </Text>
              ...
              >
                ...
                <Flex>
                  {item.product.price != item.product.price ? (
                    <>
                      <Text as="s">{item.product.price.toLocaleString()}</Text>
                      <Text>원</Text>
                    </>
                  ) : null}
                </Flex>
                ...
                >
                  ...
                  >
                    ...
                    <g mask="url(#mask0_786_2799)">
                      <path
                        d="M3 8.91665V8.08331H13V8.91665H3Z"
                        fill="#777777"
                      />
                    </g>
                  </svg>
