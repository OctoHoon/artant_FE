              ...
              <AccordionPanel pb={4}>
                ...
                >
                  <Text
                    ...
                    lineHeight={"150%"}
                  >
                    아트앤트는 이 구매에 대한 배송 및 포장으로 인한 탄소
                    배출량을 상쇄합니다.
                  </Text>
                </Box>
                <Box height={"24px"} />
                ...
                <Flex alignItems={"center"}>
                  ...
                  <Text
                    ...
                    letterSpacing={"-0.042px"}
                  >
                    아트앤트 구매 보호: 주문에 문제가 있는 경우 아트앤트에서
                    자신 있게 쇼핑하세요. 적격한 모든 구매에 대해 지원해
                    드립니다. 프로그램 약관을 참조하세요.
                  </Text>
                </Flex>
                <Box height={"24px"} />
              ...
              <AccordionPanel pb={4}>
                <Flex>
                  <Image
                    width="80px"
                    height="80px"
                    src="https://i.etsystatic.com/isla/2054f4/46375110/isla_75x75.46375110_8undele4.jpg?version=0"
                    marginRight={"20px"}
                  />
                  <Box>
                    <Text
